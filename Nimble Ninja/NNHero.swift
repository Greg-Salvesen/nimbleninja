...
class NNHero: SKSpriteNode {
    ...
    func loadPhysicsBodyWithSize(size: CGSize) {
        ...
        physicsBody?.categoryBitMask = kNNHeroCategory
        physicsBody?.contactTestBitMask = kNNWallCategory
    ...
    func flip() {
        ...
        let translate = SKAction.moveByX(0, y: scale * (body.size.height + kNNGroundHeight + 4), duration: 0.1)
